...
namespace threadPilotUserApi.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class CustomerFoundButNoVehicleInfo
    {
        /// <summary>
        ...
        /// </summary>
        [TestMethod]
        public async Task getUserInsuranceInfo_CustomerFoundButNoVehicleInfo_ExecuteWorkflow_SUCCESS_Sample1()
        {
            // PREPARE Mock
        ...
        /// </summary>
        [TestMethod]
        public async Task getUserInsuranceInfo_CustomerFoundButNoVehicleInfo_ExecuteWorkflow_SUCCESS_Sample2()
        {
            // PREPARE
            // Generate mock action and trigger data.
            var mockData = this.GetTestMockDefinition();
        ...
        /// </summary>
        [TestMethod]
        public async Task getUserInsuranceInfo_CustomerFoundButNoVehicleInfo_ExecuteWorkflow_FAILED_Sample3()
        {
            // PREPARE
            // Generate mock action and trigger data.
            var mockData = this.GetTestMockDefinition();
        ...
        {
            var mockDataPath = Path.Combine(TestExecutor.rootDirectory, "Tests", TestExecutor.logicAppName, TestExecutor.workflow, "CustomerFoundButNoVehicleInfo", "CustomerFoundButNoVehicleInfo-mock.json");
